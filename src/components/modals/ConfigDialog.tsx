...
import BPTextArea from "../blueprint/wrappers/BPTextArea";
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <BPInput type="number" defaultValue={5} />
                    </div>
                    ...
                    <div>
                      ...
                      <BPInput type="number" defaultValue={2000} />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <BPInput type="number" defaultValue={500} />
                    </div>
              ...
              {activeConfigTab === "network" && (
                <div className="grid grid-cols-1 gap-4">
                  <div>
                    ...
                    <BPInput type="number" defaultValue={15000} />
                  </div>
                  ...
                  <div>
                    ...
                    <BPInput defaultValue="mongo_prod_cluster" />
                  </div>
